...
** How do I install this?
   ...
   Before installing, you'll need IPython (>= 4.0) installed and
   working. You will also need the [[http://www.tornadoweb.org/en/stable/][Tornado]] and [[http://jupyter.readthedocs.org/en/latest/install.html][Jupyter]] libraries.

   (If you're on IPython 3 you can use the ~ipython3~ branch of this
   repo. You will also need the [[http://www.tornadoweb.org/en/stable/][Tornado]] and [[https://zeromq.github.io/pyzmq/][PyZMQ]] libraries.)
